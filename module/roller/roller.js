export class OutgunnedRoller {
    ...
    static async rollDice({ rollName = 'Roll', 
    actor = null, 
    attribute = null, 
    skill = null, 
    total = 0, 
    ...
    carryOverDice = [] } = {}) {
        ...
        //roll.toMessage();
        await OutgunnedRoller.parseRoll({ rollName: rollName, roll: roll, carryOverDice: carryOverDice, rollType: rollType, isGamble: isGamble })
    }

    static async parseRoll({ rollName = "",
    actor = null, 
    total = 0, 
    roll = null, 
    rollType = "",
    ...
    static async discard({diceGroup = 0, rollName = 'Roll', actor = null, rollType = "",  isGamble=false, carryOverDice = [], results = [] } = {}) {
        ...
        // proceed to ALL IN
        //if(isSuccess){
        await OutgunnedRoller.sendToChat({ rollName: rollName, results: cleanedResults, carryOverDice: duplicates, toReroll: toReroll, isSuccess: isSuccess, rollType: OutgunnedRoller.ROLL_TYPE_DISCARD, isGamble: isGamble })
        //}else{
    ...
    static async sendToChat({ rollName = "", results = [], carryOverDice = [], toReroll = 0, isSuccess = false, rollType = "", isGamble = false } = {}) {
